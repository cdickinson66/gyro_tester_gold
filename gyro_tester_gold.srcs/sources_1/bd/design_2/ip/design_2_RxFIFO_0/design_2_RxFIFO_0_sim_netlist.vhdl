...
--               c:/Users/Asus/Desktop/gyro_tester_gold/gyro_tester_gold.srcs/sources_1/bd/design_2/ip/design_2_RxFIFO_0/design_2_RxFIFO_0_sim_netlist.vhdl
...
entity design_2_RxFIFO_0_axis_stream_fifo_v1_0_S00_AXI is
  port (
    ...
    \rd_ptr_gray_sync2_reg_reg[11]\ : out STD_LOGIC;
    ...
    s00_rst_sync1_reg_reg : out STD_LOGIC;
    m00_rst_sync2_reg_reg : out STD_LOGIC;
    s00_rst_sync1_reg_reg_0 : out STD_LOGIC;
    ...
    \rd_addr_reg_reg[12]\ : in STD_LOGIC;
    m00_axis_tready : in STD_LOGIC;
    rd_ptr_next0 : in STD_LOGIC_VECTOR ( 11 downto 0 );
    CO : in STD_LOGIC_VECTOR ( 0 to 0 );
    \wr_ptr_gray_reg_reg[11]\ : in STD_LOGIC_VECTOR ( 12 downto 0 );
    ...
    \axi_rdata_reg[28]_0\ : in STD_LOGIC_VECTOR ( 12 downto 0 );
...
architecture STRUCTURE of design_2_RxFIFO_0_axis_stream_fifo_v1_0_S00_AXI is
  ...
  signal \^rd_ptr_gray_sync2_reg_reg[11]\ : STD_LOGIC;
...
begin
  ...
  \rd_ptr_gray_sync2_reg_reg[11]\ <= \^rd_ptr_gray_sync2_reg_reg[11]\;
...
\axi_rdata[0]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"9F90909F"
        ...
        port map (
      I0 => dbg_word2_int(0),
      I1 => \^rd_ptr_gray_sync2_reg_reg[11]\,
      I2 => axi_araddr(3),
      I3 => \out\(0),
...
full0_carry_i_2: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
        ...
        port map (
      I0 => Q(6),
      I1 => \wr_ptr_gray_reg_reg[11]\(6),
      I2 => Q(7),
      I3 => \wr_ptr_gray_reg_reg[11]\(7),
      I4 => \wr_ptr_gray_reg_reg[11]\(8),
      I5 => Q(8),
      O => S(2)
    );
full0_carry_i_3: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
        ...
        port map (
      I0 => Q(3),
      I1 => \wr_ptr_gray_reg_reg[11]\(3),
      I2 => Q(4),
      I3 => \wr_ptr_gray_reg_reg[11]\(4),
      I4 => \wr_ptr_gray_reg_reg[11]\(5),
      I5 => Q(5),
      O => S(1)
    );
full0_carry_i_4: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
        ...
        port map (
      I0 => Q(0),
      I1 => \wr_ptr_gray_reg_reg[11]\(0),
      I2 => Q(1),
      I3 => \wr_ptr_gray_reg_reg[11]\(1),
      I4 => \wr_ptr_gray_reg_reg[11]\(2),
      I5 => Q(2),
      O => S(0)
    );
...
\wr_addr_reg[11]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"00282800FFFFFFFF"
        ...
        port map (
      I0 => CO(0),
      I1 => \wr_ptr_gray_reg_reg[11]\(11),
      I2 => Q(11),
      I3 => Q(12),
      I4 => \wr_ptr_gray_reg_reg[11]\(12),
      I5 => s00_axis_tvalid,
      O => \^rd_ptr_gray_sync2_reg_reg[11]\
    );
end STRUCTURE;
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
...
architecture STRUCTURE of design_2_RxFIFO_0_axis_stream_fifo_v1_0 is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \wr_addr_reg[0]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \wr_addr_reg[10]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \wr_addr_reg[11]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \wr_addr_reg[1]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \wr_addr_reg[2]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \wr_addr_reg[3]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \wr_addr_reg[4]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \wr_addr_reg[5]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \wr_addr_reg[6]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \wr_addr_reg[7]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \wr_addr_reg[8]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \wr_addr_reg[9]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \wr_ptr_gray_reg[0]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \wr_ptr_gray_reg[10]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \wr_ptr_gray_reg[11]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \wr_ptr_gray_reg[1]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \wr_ptr_gray_reg[2]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \wr_ptr_gray_reg[3]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \wr_ptr_gray_reg[4]_i_1\ : label is "soft_lutpair10";
...
axis_stream_fifo_v1_0_S00_AXI_inst: entity work.design_2_RxFIFO_0_axis_stream_fifo_v1_0_S00_AXI
     port map (
      ...
      \axi_rdata_reg[28]_0\(12 downto 0) => wr_addr_reg(12 downto 0),
      ...
      m00_rst_sync2_reg_reg => axis_stream_fifo_v1_0_S00_AXI_inst_n_37,
      ...
      \rd_addr_reg_reg[12]\ => \^m00_axis_tvalid_reg_reg_0\,
      \rd_ptr_gray_reg_reg[12]\(12 downto 0) => rd_ptr_gray_reg(12 downto 0),
      \rd_ptr_gray_sync2_reg_reg[11]\ => axis_stream_fifo_v1_0_S00_AXI_inst_n_5,
      ...
      s00_rst_sync1_reg_reg => axis_stream_fifo_v1_0_S00_AXI_inst_n_36,
      s00_rst_sync1_reg_reg_0 => axis_stream_fifo_v1_0_S00_AXI_inst_n_38,
      s00_rst_sync2_reg_reg => axis_stream_fifo_v1_0_S00_AXI_inst_n_35,
      \wr_ptr_gray_reg_reg[11]\(12) => p_0_in0_in,
      \wr_ptr_gray_reg_reg[11]\(11) => p_0_in,
      \wr_ptr_gray_reg_reg[11]\(10) => \rd_ptr_gray_sync2_reg_reg_n_0_[10]\,
      \wr_ptr_gray_reg_reg[11]\(9) => \rd_ptr_gray_sync2_reg_reg_n_0_[9]\,
      \wr_ptr_gray_reg_reg[11]\(8) => \rd_ptr_gray_sync2_reg_reg_n_0_[8]\,
      \wr_ptr_gray_reg_reg[11]\(7) => \rd_ptr_gray_sync2_reg_reg_n_0_[7]\,
      \wr_ptr_gray_reg_reg[11]\(6) => \rd_ptr_gray_sync2_reg_reg_n_0_[6]\,
      \wr_ptr_gray_reg_reg[11]\(5) => \rd_ptr_gray_sync2_reg_reg_n_0_[5]\,
      \wr_ptr_gray_reg_reg[11]\(4) => \rd_ptr_gray_sync2_reg_reg_n_0_[4]\,
      \wr_ptr_gray_reg_reg[11]\(3) => \rd_ptr_gray_sync2_reg_reg_n_0_[3]\,
      \wr_ptr_gray_reg_reg[11]\(2) => \rd_ptr_gray_sync2_reg_reg_n_0_[2]\,
      \wr_ptr_gray_reg_reg[11]\(1) => \rd_ptr_gray_sync2_reg_reg_n_0_[1]\,
      \wr_ptr_gray_reg_reg[11]\(0) => \rd_ptr_gray_sync2_reg_reg_n_0_[0]\,
