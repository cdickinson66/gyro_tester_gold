...
#
# build.tcl: Tcl script for re-creating project 'gyro_tester_gold'
#
# Generated by Vivado on Wed Mar 16 00:47:42 -0700 2022
...
#
#    "C:/Xilinx_projects/Vivado/projects/gyro_tester_gold/gyro_tester_gold.srcs/sources_1/bd/design_2/design_2.bd"
#    "C:/Xilinx_projects/Vivado/projects/gyro_tester_gold/gyro_tester_gold.srcs/sources_1/bd/design_2/hdl/design_2_wrapper.v"
#    "C:/Xilinx_projects/Vivado/projects/gyro_tester_gold/gyro_tester_gold.srcs/constrs_2/new/gyro_constraints.xdc"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/gyro_tester_gold.srcs/sources_1/bd/design_2/design_2.bd"]"\
 "[file normalize "$origin_dir/gyro_tester_gold.srcs/sources_1/bd/design_2/hdl/design_2_wrapper.v"]"\
 "[file normalize "$origin_dir/gyro_tester_gold.srcs/constrs_2/new/gyro_constraints.xdc"]"\
  ]
  foreach ifile $files {
  ...
  set paths [list \
 "[file normalize "$origin_dir/../../../../Users/Asus/AppData/Users/Asus/ip_repo"]"]"\
  ]
  foreach ipath $paths {
...
set _xil_proj_name_ "gyro_tester_gold"
...
set_property -name "webtalk.activehdl_export_sim" -value "213" -objects $obj
set_property -name "webtalk.ies_export_sim" -value "213" -objects $obj
set_property -name "webtalk.modelsim_export_sim" -value "213" -objects $obj
set_property -name "webtalk.questa_export_sim" -value "213" -objects $obj
set_property -name "webtalk.riviera_export_sim" -value "213" -objects $obj
set_property -name "webtalk.vcs_export_sim" -value "213" -objects $obj
set_property -name "webtalk.xsim_export_sim" -value "213" -objects $obj
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/../../../../Users/Asus/ip_repo"]" $obj
...
set file "$origin_dir/gyro_tester_gold.srcs/sources_1/bd/design_2/design_2.bd"
...
set file "[file normalize ${origin_dir}/gyro_tester_gold.srcs/constrs_2/new/gyro_constraints.xdc]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/gyro_tester_gold.srcs/constrs_2/new/gyro_constraints.xdc"
set file [file normalize $file]
...
set obj [get_filesets constrs_2]
set_property -name "target_constrs_file" -value "$orig_proj_dir/gyro_tester_gold.srcs/constrs_2/new/gyro_constraints.xdc" -objects $obj
set_property -name "target_ucf" -value "$orig_proj_dir/gyro_tester_gold.srcs/constrs_2/new/gyro_constraints.xdc" -objects $obj
...
if {[string equal [get_runs -quiet synth_2] ""]} {
    create_run -name synth_2 -part xc7z020clg484-1 -flow {Vivado Synthesis 2018} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_2
} else {
...
set_property -name "auto_incremental_checkpoint.directory" -value "C:/Users/Asus/Desktop/gyro_tester_gold/gyro_tester_gold.srcs/utils_1/imports/synth_2" -objects $obj
...
if {[string equal [get_runs -quiet impl_4] ""]} {
    create_run -name impl_4 -part xc7z020clg484-1 -flow {Vivado Implementation 2018} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_2 -parent_run synth_2
} else {
...
set obj [get_runs impl_4]
set_property -name "constrset" -value "constrs_2" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "C:/Users/Asus/Desktop/gyro_tester_gold/gyro_tester_gold.srcs/utils_1/imports/impl_4" -objects $obj
...
set_property -name "reports" -value "impl_4#impl_4_route_report_drc_0" -objects $obj
...
set_property -name "reports" -value "impl_4#impl_4_route_report_methodology_0" -objects $obj
...
set_property -name "reports" -value "impl_4#impl_4_route_report_power_0" -objects $obj
...
set_property -name "reports" -value "impl_4#impl_4_route_report_timing_summary_0" -objects $obj
...
set_property -name "reports" -value "impl_4#impl_4_place_report_utilization_0" -objects $obj
